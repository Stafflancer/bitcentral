		...
		<div class="inner d-flex flex-row-wrap">
			<div class="text-block white-text">
				<div class="custom-breadcrumb d-flex flex-row-wrap align-items-center">
					...
					<a href="<?php echo $case_study_cpt->rewrite['slug']; ?>/"><?php echo $case_study_cpt->label; ?></a>
				</div>
				<h1><?php the_title(); ?></h1>
			</div>
		</div>
		...
		<div class="two-col d-flex flex-row-wrap">
			...
			if(!empty($related_case_study)){ ?>
				<div class="group-main">
					<div class="wrap m-auto">
						<div class="section-title"><?php echo get_field('heading_for_case_study'); ?></div>
					</div>
					<div class="grid-post">
								...
								<div class="post-col">
									<a href="<?php the_permalink($p); ?>">
										...
										<div class="content">
											...
											<h3><?php echo apply_filters( 'the_title', $related_case_study_list->post_title ); ?></h3>
											<div class="read-more"><?php echo get_field('button_text_case_studies'); ?><?php echo svg_icon('arrow-right'); ?></div>
										</div>
									</a>
								</div>
							<?php
			...
			?>
				<div class="group-main">
					<div class="wrap m-auto">
						<div class="section-title"><?php echo get_field('heading_for_white_paper'); ?></div>
					</div>
					<div class="grid-post">
						<div class="listing d-flex flex-wrap">
							<?php
								...
								<div class="post-col">
									<a href="<?php the_permalink($p); ?>">
										...
										<div class="content">
											...
											<h3><?php echo apply_filters( 'the_title', $related_white_paper_list->post_title ); ?></h3>
											<div class="read-more"><?php echo get_field('button_text_case_studies'); ?><?php echo svg_icon('arrow-right'); ?></div>
										</div>
									</a>
								</div>
