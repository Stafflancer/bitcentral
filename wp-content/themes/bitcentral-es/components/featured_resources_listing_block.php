                        ...
                        ?>
                            <div class="post-col">
                                <a href="<?php the_permalink($p); ?>">
                                    ...
                                    <div class="content">
                                        <div class="section-title"><?php the_sub_field('box_top_title'); ?></div>
                                        <h3><?php echo $brochure_list->post_title; ?></h3>
                                        <div class="read-more"><?php the_sub_field('learn_more_button_text'); ?><?php echo svg_icon('arrow-right'); ?></div>
                                    </div>
                                </a>
                            </div>
