<?php if( get_row_layout() == 'case_study_listing_block' ):
...
<section class="resources-listing">
	<div class="sticky-link-group">
		<ul class="d-flex flex-row-wrap align-items-center justify-content-center hide-static">
			...
			<li><a href="<?php echo $case_study_cpt->rewrite['slug']; ?>/" class="scroll active"><?php echo $case_study_cpt->label; ?></a></li>
	...
	<div class="container">
		<div id="cases-tudies" class="group-main case-studies-list">
			<div class="grid-post">
				<div class="listing d-flex flex-wrap">
					<?php
					$paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
					$case_study = ['post_type' => 'case_study', 'post_status' => 'publish', 'posts_per_page' => '12','paged' => $paged];
					$my_query  = new WP_Query( $case_study );
