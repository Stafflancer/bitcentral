<?php
/**
 * The template for displaying specific tag fuel posts
 */
get_header();
$fuel_tag_object = get_queried_object();
$fuel_tag_id = $fuel_tag_object->term_id;
...
?>
<div class="fuel-bitcentral-tag-page">
    ...
    if ($query_archive_fuel_posts->have_posts()) :
        ...
        <div class="fuel-related-stories">
            <div class="fuel-related-stories-container">
                ...
                <?php echo fuel_bitcentral_tiles_tag_ul($query_archive_fuel_posts, 'false'); ?>
            </div>
        </div>
        <?php
    endif;
